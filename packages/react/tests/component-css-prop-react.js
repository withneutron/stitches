...
describe('React Component with CSS prop', () => {
	...
	test('XYZ', () => {
		...
		expect(toString()).toBe('--sxs{--sxs:2 c-bMUtqP}@media{.c-bMUtqP{line-height:1}.c-bMUtqP{margin:0;font-weight:400;font-variant-numeric:tabular-nums;display:block}}')
